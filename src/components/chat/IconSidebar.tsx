...
const ChatCircleIcon = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M10.0001 1.875C8.5973 1.87469 7.21836 2.23757 5.99745 2.9283C4.77654 3.61904 3.75526 4.6141 3.03301 5.81664C2.31077 7.01918 1.91216 8.38822 1.87599 9.79052C1.83983 11.1928 2.16733 12.5806 2.82663 13.8188L1.93991 16.4789C1.86646 16.6992 1.8558 16.9355 1.90913 17.1615C1.96245 17.3874 2.07765 17.5941 2.24182 17.7582C2.40599 17.9224 2.61264 18.0376 2.8386 18.0909C3.06456 18.1443 3.30091 18.1336 3.52116 18.0602L6.18131 17.1734C7.27098 17.753 8.47836 18.0767 9.7118 18.12C10.9453 18.1633 12.1724 17.925 13.3 17.4232C14.4276 16.9215 15.426 16.1694 16.2196 15.2241C17.0132 14.2789 17.5809 13.1652 17.8798 11.9678C18.1788 10.7703 18.2009 9.52047 17.9447 8.31315C17.6885 7.10584 17.1605 5.97276 16.401 4.99993C15.6415 4.02711 14.6703 3.24009 13.5612 2.69864C12.4521 2.15718 11.2343 1.87551 10.0001 1.875ZM10.0001 16.875C8.79145 16.8758 7.60405 16.5575 6.55788 15.9523C6.48128 15.9079 6.39612 15.8803 6.30803 15.8713C6.21995 15.8622 6.13095 15.872 6.04694 15.9L3.12506 16.875L4.09928 13.9531C4.12737 13.8692 4.13729 13.7802 4.1284 13.6921C4.11951 13.604 4.09201 13.5188 4.04772 13.4422C3.28989 12.132 2.98562 10.6083 3.18212 9.10747C3.37862 7.60667 4.0649 6.21267 5.13451 5.14171C6.20411 4.07076 7.59725 3.38271 9.09779 3.18431C10.5983 2.98592 12.1224 3.28826 13.4336 4.04444C14.7448 4.80062 15.7698 5.96837 16.3496 7.36652C16.9293 8.76468 17.0315 10.3151 16.6402 11.7773C16.249 13.2394 15.3861 14.5316 14.1855 15.4533C12.9849 16.375 11.5137 16.8748 10.0001 16.875Z" fill="#151515"/>
  </svg>
);
...
const LogoIcon = () => (
  <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g clipPath="url(#clip0_logo)">
      <path fillRule="evenodd" clipRule="evenodd" d="M12.1001 19.25V28.05H14.8501C15.139 28.05 15.4251 28.1069 15.692 28.2175C15.9589 28.328 16.2015 28.4901 16.4057 28.6944C16.61 28.8987 16.7721 29.1412 16.8827 29.4081C16.9932 29.675 17.0501 29.9611 17.0501 30.25V33H23.6501L31.9001 24.75V15.95H29.1501C28.8612 15.95 28.5751 15.8931 28.3082 15.7825C28.0413 15.672 27.7987 15.5099 27.5945 15.3056C27.3902 15.1014 27.2281 14.8588 27.1175 14.5919C27.007 14.325 26.9501 14.0389 26.9501 13.75V11H20.3501L12.1001 19.25ZM21.4501 27.5H17.6001V21.45L22.5501 16.5H26.4001V22.55L21.4501 27.5Z" fill="white"/>
    </g>
    <defs>
      <clipPath id="clip0_logo">
        <rect width="19.8" height="22" fill="white" transform="translate(12.0999 11)"/>
      </clipPath>
    </defs>
  </svg>
);
...
const navItems = [
  ...
  { icon: ChatCircleIcon, label: "Messages", active: true },
